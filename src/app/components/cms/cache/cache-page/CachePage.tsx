...
import { Stack, Grid, Alert, LoadingOverlay, Box, Paper } from '@mantine/core';
      ...
      <Paper p="md" radius="md">
        <Stack gap="md">
          ...
          <PageHeader
            ...
            subtitle="Monitor cache performance, clear specific cache categories, and manage cache health. Use cache operations carefully as they may impact application performance."
          />
