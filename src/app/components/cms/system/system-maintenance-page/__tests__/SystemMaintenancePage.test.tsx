...
function health(): ISystemHealth {
    return {
        ...
        safe_mode: false,
        maintenance_mode: false,
        version: { selfhelp: '8.0.0', backend: '8.0.0', frontend: '8.0.0', plugin_api: '2.1', database_migration: 'Version20260608174905' },
            ...
            advisories: [
                {
                    ...
                    affected: [{ kind: 'core', id: 'selfhelp-core', installed_version: '8.0.0' }],
                    fixed_versions: ['8.0.1'],
                },
            ],
        };
