                ...
                {showMobile && (
                    ...
                    >
                        {availability === 'checking' ? (
                            ...
                            // A realistic device bezel around the scaled screen: a
                            // dark rounded frame + drop shadow, mirroring the mobile
                            // app's own PhoneFrame so the preview reads like a phone
                            // rather than a flat web card. The screen height is sized
                            // via `frameChromeHeight` above so the bezel never clips
