...
> [`docs/architecture/ssr-bff-architecture.md`](../ssr-bff-architecture.md)
...
**[← Back to Main Guide](../../archive/comprehensive-frontend-guide.md)** | **[Next: Authentication System →](./02-authentication-system.md)**
